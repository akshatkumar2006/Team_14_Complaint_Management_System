                                    ...
                                    <table id="default_order" class="table table-striped table-bordered display no-wrap" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>${com.status}</td>
                                                <td>
                                                    <a href="/dept/viewResolved?compid=${com.id}&deptId=${dept_id}" class="btn waves-effect waves-light btn-rounded btn-dark viewBtn">View</a>
                                                </td>
                                            </tr>
                                            </c:forEach>
                                        </tbody>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="/dept/logout" type="button" class="btn btn-primary"><i data-feather="log-out" class="feather-icon"></i> Logout</a>
